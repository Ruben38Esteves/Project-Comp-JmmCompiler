...
import pt.up.fe.comp2024.analysis.passes.CheckArrayInit;
import pt.up.fe.comp2024.analysis.passes.CheckEqualType;
import pt.up.fe.comp2024.analysis.passes.UndeclaredVariable;
import pt.up.fe.comp2024.analysis.passes.CheckOpType;
...
public class JmmAnalysisImpl implements JmmAnalysis {
    ...
    public JmmAnalysisImpl() {
        ...
        this.analysisPasses = List.of(new UndeclaredVariable(), new CheckOpType(), new CheckArrayInit(), new CheckEqualType());
    }
